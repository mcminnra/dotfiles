...
;; }
  ...
  (custom-theme-set-faces
   ...
   `(org-meta-line ((t (:foreground ,grey :slant italic))))
   ...
   `(org-checkbox-statistics-done ((t (:foreground ,grey))))
   ...
   `(org-block-begin-line ((t (:background ,crust :foreground ,grey :slant italic))))
   `(org-block-end-line ((t (:background ,crust :foreground ,grey :slant italic))))
