...
This document provides the scientific rationale for the techniques in learn.md. Consult it when adapting techniques or making judgment calls about learning approaches.
